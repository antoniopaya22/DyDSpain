...
export default function CombatTab() {
  ...
  const handleDeathFailure = async () => {
    ...
    if (result === "dead") {
      showAlert("Muerte", "Has acumulado 3 fallos. Tu personaje ha muerto.", {
        type: "danger",
        buttonText: "OK",
      });
    }
  ...
  const renderStatsRow = () => (
    <View className="flex-row mb-4">
      {/* Armor Class */}
      <View className="flex-1 bg-white dark:bg-surface-card rounded-card border border-dark-100 dark:border-surface-border p-4 mr-2 items-center">
      ...
      {/* Initiative */}
      <View className="flex-1 bg-white dark:bg-surface-card rounded-card border border-dark-100 dark:border-surface-border p-4 mx-1 items-center">
      ...
      {/* Speed */}
      <View className="flex-1 bg-white dark:bg-surface-card rounded-card border border-dark-100 dark:border-surface-border p-4 ml-2 items-center">
  ...
  const renderDeathSaves = () => {
    ...
    return (
      <View className="bg-white dark:bg-surface-card rounded-card border border-red-500/30 p-4 mb-4">
  ...
  const renderRestButtons = () => (
    <View className="flex-row mb-4">
      <TouchableOpacity
        className="flex-1 bg-white dark:bg-surface-card rounded-card border border-dark-100 dark:border-surface-border p-4 mr-2 items-center active:bg-gray-50 dark:active:bg-surface-light"
      ...
      <TouchableOpacity
        className="flex-1 bg-white dark:bg-surface-card rounded-card border border-dark-100 dark:border-surface-border p-4 ml-2 items-center active:bg-gray-50 dark:active:bg-surface-light"
        ...
        <View className="px-4 pb-4 border-t border-dark-100 dark:border-surface-border/50">
          {character.combatLog.length === 0 ? (
            ...
            character.combatLog.slice(0, 20).map((entry) => {
              ...
              > = {
                damage: { icon: "flash", color: colors.accentDanger },
                healing: { icon: "heart", color: colors.accentGreen },
                temp_hp: { icon: "shield", color: colors.accentBlue },
                hit_dice: { icon: "dice", color: colors.accentPurple },
                death_save: { icon: "skull", color: colors.accentAmber },
                rest: { icon: "moon", color: colors.accentLightBlue },
              };
